...
let with_duplicate_state _ =
    ...
    assert_raises (Invalid_machine_state (err_state_duplicate, "eraseone")) (fun () -> check_machine machine)
...
let tests =
    "suite_check_machine" >::: [
        ...
        "with_duplicate_state" >:: with_duplicate_state;
